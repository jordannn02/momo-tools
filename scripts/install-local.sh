...
rm -rf "$install_root/tests" "$install_root/docs" "$install_root/examples" "$install_root/evidence" "$install_root/demo"
...
cp -R "$repo_root/evidence" "$install_root/evidence"
cp -R "$repo_root/demo" "$install_root/demo"
...
cp "$repo_root/capabilities.schema.json" "$install_root/capabilities.schema.json"
cp "$repo_root/CONTRIBUTING.md" "$install_root/CONTRIBUTING.md"
